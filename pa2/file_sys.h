...
class inode_state {
   ...
   public:
      ...
      void set_prompt(string that){prompt_ = that + " ";}
      inode_ptr& get_root() {return this->root;}
      void set_root(inode_ptr r){this->root = r;}
      inode_ptr& get_cwd(){return this->cwd;}
      void set_cwd(inode_ptr c){this->cwd = c;}
};
...
class base_file {
   ...
   public:
      ...
      virtual void set_data(wordvec& that);
...
class plain_file: public base_file {
   ...
   public:
      ...
      virtual void set_data(wordvec& d) {data = d;}
};
